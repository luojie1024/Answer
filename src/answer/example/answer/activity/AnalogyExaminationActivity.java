package answer.example.answer.activity;
...
import answer.example.answer.adapter.ExaminationSubmitAdapter;
import answer.example.answer.adapter.SimulationExaminationAdapter;
import answer.example.answer.bean.AnSwerInfo;
import answer.example.answer.bean.ErrorQuestionInfo;
import answer.example.answer.bean.SaveQuestionInfo;
import answer.example.answer.database.DBManager;
import answer.example.answer.database.DataBaseHelper;
import answer.example.answer.database.DataBaseManager;
import answer.example.answer.util.ConstantUtil;
import answer.example.answer.util.ViewPagerScroller;
import answer.example.answer.view.VoteSubmitViewPager;
